...
window["Coral"]["templates"]["RichTextEditor"]["fullscreen_dialog"] = (function anonymous(data_0
  ...
  if (data_0["allowMinimize"]) {
    ...
    el23.setAttribute("title", CUI["rte"]["Utils"]["i18n"]('plugins.fullscreen.toggleTitle'));
    el23.setAttribute("aria-label", CUI["rte"]["Utils"]["i18n"]('plugins.fullscreen.toggleTitle'));
    el23.setAttribute("tabindex", "-1");
...
window["Coral"]["templates"]["RichTextEditor"]["paraformat_pulldown"] = (function anonymous(data_0
  ...
  for (var i1 = 0, ni1 = iterated_1.length; i1 < ni1; i1++) {
    ...
    el5.textContent = data_1["description"];
    el4.appendChild(el5);
    el0.appendChild(el4);
    var el6 = document.createTextNode("\n");
    el0.appendChild(el6);
...
window["Coral"]["templates"]["RichTextEditor"]["popover_trigger"] = (function anonymous(data_0
  ...
  var el1 = document.createTextNode("\n  ");
  el0.appendChild(el1);
  var el2 = document.createElement("coral-button-label");
  var el3 = document.createTextNode("\n    ");
  el2.appendChild(el3);
...
window["Coral"]["templates"]["RichTextEditor"]["toolbar_item"] = (function anonymous(data_0
  ...
  if (data_0["trigger"]) {
    var el3 = document.createTextNode("\n    ");
    el0.appendChild(el3);
    var el4 = document.createElement("coral-button-label");
    var el5 = document.createTextNode("\n      ");
    el4.appendChild(el5);
    var el6 = document.createElement("coral-icon");
    el6.setAttribute("icon", "chevronDown");
    el6.setAttribute("size", "xxs");
    el6.className += " rte-openIcon";
    el4.appendChild(el6);
    var el7 = document.createTextNode("\n    ");
    el4.appendChild(el7);
    el0.appendChild(el4);
